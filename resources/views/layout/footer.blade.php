    ...
    <div class="container">
        <div class="footer_main d-sm-flex flex-wrap flex-lg-nowrap justify-content-between">
            <div class="footer_main-block footer_main-block--about col-sm-7 col-lg-auto d-flex flex-column">
                <h4 class="footer_main-block_header">About</h4>
                <p class="footer_main-block_text">
                    allearstravel is an online travel agency (OTA) with focus on Disney holidays. We are operated by Mousegineers Limited.
                </p>
            </div>
            <div class="footer_main-block footer_main-block--nav col-sm-6 col-lg-auto">
                <h4 class="footer_main-block_header">Information</h4>
    ...
    <div class="footer_copyright">
        <div class="container">
            <p class="footer_copyright-text">
                <span class="linebreak">allearstravel.com is a trading name of Mousegineers Limited, 5 South Charlotte Street, EH2 4AN, Edinburgh.</span>
            </p>
        </div>
    </div>
</footer>
