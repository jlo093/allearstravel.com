...
<section class="hero section">
    <div class="container container--hero d-lg-flex align-items-center justify-content-between">
        <div class="hero_main">
            <h1 class="hero_main-title" data-aos="fade-up">Disney World</h1>
            ...
            <form class="booking" action="{{ route('search.index') }}" method="post" autocomplete="off" data-aos="fade-up" id="booking-form">
                ...
                <input type="hidden" value="{{ \App\Enums\RegionEnum::DISNEY_WORLD->value }}" name="region_id" />
                                    ...
                                    >
                                        ...
                                        <div class="main d-flex align-items-center justify-content-between">
                                            <a
                                                ...
                                                data-disabled="true"
                                            ></a>
                                            <input class="field required" name="adults" id="adults" type="text" value="1" />
                                            <a
                                    ...
                                    >
                                        ...
                                        <div class="main d-flex align-items-center justify-content-between">
                                            <a
                                                ...
                                                data-disabled=""
                                            ></a>
                                            <input class="field required" name="children" id="children" type="text" value="0" />
                                            <a
                                                class="qty_plus qty-changer d-flex align-items-center justify-content-center"
                                                href="#"
                                                data-disabled=""
        ...
        <div class="hero_media" data-aos="zoom-in">
            <picture>
                ...
                <img class="lazy" data-src="/img/orlando.jpg" src="/img/orlando.jpg" alt="media" />
            </picture>
        </div>
    </div>
</section>
